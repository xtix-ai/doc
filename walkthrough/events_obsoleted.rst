...
.. _walkthrough/events_obsoleted/begin:

====================================================
Шаг 1: Информация о мероприятии (устаревшие сервисы)
====================================================


.. _walkthrough/events_obsoleted/simple:
...
**Ответ**:
    ...
    - ``map`` схема зала  (id схемы и ссылки на svg)
...
.. _walkthrough/events_obsoleted/tickets:
...
================================================
       ...
       - ``city`` - целое число
       - ``country`` - целое число
       - ``lifetime`` - диапазон дата_время формата iso8601
       - ``price`` - диапазон строк с дробным или целым числом
       - ``view_limit`` - строка, возможные значения *salespoint*, *showroom*
